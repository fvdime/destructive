...
import { likePost } from "@/actions/likes.actions";
import { Like } from "@prisma/client";
import React, { useCallback, useMemo, useOptimistic, useState } from "react";
...
export default function LikeButton({
  ...
  const postLike = (like: Like) => like.userId === userId && like.postId === postId
